    ...
    extends AbstractPredicate
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "decimalValue", namespace = "http://rice.kuali.org/core/v2_0", type = JAXBElement.class),
        @XmlElementRef(name = "stringValue", namespace = "http://rice.kuali.org/core/v2_0", type = JAXBElement.class),
        @XmlElementRef(name = "integerValue", namespace = "http://rice.kuali.org/core/v2_0", type = JAXBElement.class),
        @XmlElementRef(name = "kualiIntegerValue", namespace = "http://rice.kuali.org/core/v2_0", type = JAXBElement.class),
        @XmlElementRef(name = "kualiPercentValue", namespace = "http://rice.kuali.org/core/v2_0", type = JAXBElement.class),
        @XmlElementRef(name = "dateTimeValue", namespace = "http://rice.kuali.org/core/v2_0", type = JAXBElement.class),
        @XmlElementRef(name = "kualiDecimalValue", namespace = "http://rice.kuali.org/core/v2_0", type = JAXBElement.class)
    })
