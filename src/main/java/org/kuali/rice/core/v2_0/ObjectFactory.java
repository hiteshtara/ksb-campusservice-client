...
public class ObjectFactory {
    ...
    private final static QName _NotLikeIgnoreCase_QNAME = new QName("http://rice.kuali.org/core/v2_0", "notLikeIgnoreCase");
    private final static QName _PropertyPathValue_QNAME = new QName("http://rice.kuali.org/core/v2_0", "propertyPathValue");
    ...
    private final static QName _PropertyPath_QNAME = new QName("http://rice.kuali.org/core/v2_0", "propertyPath");
    ...
    private final static QName _ExistsSubQuery_QNAME = new QName("http://rice.kuali.org/core/v2_0", "existsSubQuery");
    ...
    private final static QName _KualiIntegerValue_QNAME = new QName("http://rice.kuali.org/core/v2_0", "kualiIntegerValue");
    ...
    /**
     * Create an instance of {@link PropertyPathType }
     * 
     */
    public PropertyPathType createPropertyPathType() {
    ...
    /**
     * Create an instance of {@link ExistsSubQueryType }
     * 
     */
    public ExistsSubQueryType createExistsSubQueryType() {
        return new ExistsSubQueryType();
    }
    ...
    /**
     * Create an instance of {@link NotLikeIgnoreCaseType }
     * 
     */
    public NotLikeIgnoreCaseType createNotLikeIgnoreCaseType() {
        return new NotLikeIgnoreCaseType();
    }
    ...
    /**
     * Create an instance of {@link CriteriaPropertyPathValueType }
     * 
     */
    public CriteriaPropertyPathValueType createCriteriaPropertyPathValueType() {
        return new CriteriaPropertyPathValueType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link NotLikeIgnoreCaseType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://rice.kuali.org/core/v2_0", name = "notLikeIgnoreCase")
    public JAXBElement<NotLikeIgnoreCaseType> createNotLikeIgnoreCase(NotLikeIgnoreCaseType value) {
        return new JAXBElement<NotLikeIgnoreCaseType>(_NotLikeIgnoreCase_QNAME, NotLikeIgnoreCaseType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link CriteriaPropertyPathValueType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://rice.kuali.org/core/v2_0", name = "propertyPathValue")
    public JAXBElement<CriteriaPropertyPathValueType> createPropertyPathValue(CriteriaPropertyPathValueType value) {
        return new JAXBElement<CriteriaPropertyPathValueType>(_PropertyPathValue_QNAME, CriteriaPropertyPathValueType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link PropertyPathType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://rice.kuali.org/core/v2_0", name = "propertyPath")
    public JAXBElement<PropertyPathType> createPropertyPath(PropertyPathType value) {
        return new JAXBElement<PropertyPathType>(_PropertyPath_QNAME, PropertyPathType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ExistsSubQueryType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://rice.kuali.org/core/v2_0", name = "existsSubQuery")
    public JAXBElement<ExistsSubQueryType> createExistsSubQuery(ExistsSubQueryType value) {
        return new JAXBElement<ExistsSubQueryType>(_ExistsSubQuery_QNAME, ExistsSubQueryType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rice.kuali.org/core/v2_0", name = "kualiIntegerValue")
    public JAXBElement<BigInteger> createKualiIntegerValue(BigInteger value) {
        return new JAXBElement<BigInteger>(_KualiIntegerValue_QNAME, BigInteger.class, null, value);
    }
